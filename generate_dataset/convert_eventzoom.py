...
def get_flags():
    ...
    parser.add_argument('--root_data_path', default='/eventZooM')
    parser.add_argument('--path_to_h5', default='/eventZooM/h5_data')
...
if __name__ == '__main__':
    ...
    path_to_hr = os.path.join(root_data_path, 'ev_hr')
    path_to_lr = os.path.join(root_data_path, 'ev_lr_1')
    path_to_llr = os.path.join(root_data_path, 'ev_llr_1')
