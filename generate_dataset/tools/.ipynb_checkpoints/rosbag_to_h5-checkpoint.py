...
def extract_rosbags(rosbag_paths, output_dir, event_topic, image_topic, flow_topic, start_time, end_time,
    ...
    for path in rosbag_paths:
        ...
        extract_rosbag(path, out_path, event_topic, image_topic=image_topic,
                       flow_topic=flow_topic, zero_timestamps=zero_timestamps, start_time=start_time, end_time=end_time,
...
if __name__ == "__main__":
    ...
    extract_rosbags(rosbag_paths, args.output_dir, args.event_topic, args.image_topic,
            args.flow_topic, zero_timestamps=args.zero_timestamps, is_color=args.is_color, start_time=args.start_time, end_time=args.end_time,
